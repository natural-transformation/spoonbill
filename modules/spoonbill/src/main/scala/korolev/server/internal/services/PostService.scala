...
import spoonbill.internal.Frontend.DownloadFileMeta
import spoonbill.server.HttpResponse
import spoonbill.server.internal.FormDataCodec
import spoonbill.web.{Headers, Response}
import scala.concurrent.ExecutionContext

private[spoonbill] final class PostService[F[_]: Effect](
  reporter: Reporter,
